<div id="wrapper">
    ...
    <?php foreach ($brand as $r):?>      
        <a href="<?= base_url($r["nama_brand"])?>"><img class="rekayasaB <?= \Config\Services::request()->uri->getSegment(1) == $r["nama_brand"] ? 'active' : '' ?>" src="/assets/images/logo/<?=$r["nama_brand"]?>_logo.jpg" ></img></a>
    <?php endforeach;?>     
    </center>
	...
	<div class="card">
	    ...
	    <div class="body-card ">
			...
			<span class="tooltip" data-tooltip="Klik Tanda Panah Untuk Lihat Lebih Lengkap">
